...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{SDK.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{AppOnExpo.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{AddTask.jpg}
        \caption{Adding Task}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{EditTask.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{DeleteApp.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{InitialTodo.jpg}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{RunTodo.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{MarkTask.jpg}
